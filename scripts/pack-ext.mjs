...
//
//   chrome   src/manifest.json + src/rules/ verbatim — they are generated by
//            scripts/gen-ext.mjs, which owns them (the static ruleset needs
//            the pinned extension id baked into its redirect URL).
//   firefox  manifest from scripts/lib/manifest.mjs, no static ruleset (a
//            moz-extension UUID is per profile, so the SW installs the
//            catch-all dynamically).
//
...
const SKIP = {
  ...
  firefox: new Set(['_metadata', 'manifest.json', 'rules']),
};
